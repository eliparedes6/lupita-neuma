...
function LoginScreen({ error }) {
  ...
  const errorMessages = {
    domain_not_allowed: "Solo cuentas @neumaagencia.com pueden acceder.",
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#07090C", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Georgia', serif", padding: 20 }}>
      ...
      <div style={{ maxWidth: 400, width: "100%", textAlign: "center", animation: "lupIn 0.4s ease" }}>
        ...
        <p style={{ fontSize: 11, color: "#1a3a1a", marginTop: 20, lineHeight: 1.6 }}>Solo cuentas <strong style={{ color: "#2a5a2a" }}>@neumaagencia.com</strong> tienen acceso.</p>
      </div>
    </div>
  );
}
